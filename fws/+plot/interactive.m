...
% PLOT.INTERACTIVE: One line description of what the function or script performs
%
%   __           _
%  / _|         (_)
...
% EXAMPLES:
%{
interactive(input01,input02,input03,input04)
%}
%
% DEPENDENCIES:
%
...
uicontrol(fg,'Style', 'pushbutton', 'String', 'Export',...
    ...
    'BackgroundColor',fws.hex2rgb("BBDCF5"),'Tag','Report');
...
text(main,7.5,0.535,'fWS ROIs (MNI)','FontSize',22,'FontWeight','bold')

plot.ui_bar(AX{5},obj.table.Peak,1:height(obj.table),obj.colour_map,'Peak magnitude','ROIs');
