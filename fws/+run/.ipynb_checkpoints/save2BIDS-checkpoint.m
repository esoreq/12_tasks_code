...
for r = Data.fileMapping.PREFolder'
      ...
      bold_json = struct('TaskName',hdr.ProtocolName,...
  ...
  headers = {'Task' 'Block' 'onset' 'duration' 'cumDur'};
for r = Data.fileMapping.PREFolder'
    ix = c3nl.strDetect(fn,sprintf('%s/',r{1}));
    tmp = Data.onsets(Data.onsets.Task==Data.fileMapping.taskName{ix},:);
    T = table(tmp.Task,tmp.Block,tmp.Time./1000,tmp.Dur./1000,tmp.cumDur,'VariableNames',headers);
